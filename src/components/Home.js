...
function Home(){
 return(
    <div>
         <div className='head'>
          <div>
          <img src={logo} alt='By Graces' id="l-p"/>
          </div>
             {/* <h1 className='main'>By Graces</h1> */}
            <center>
              <p id="quote"><em>"The best way to find yourself is to loss yourself in the service of others"</em></p>
            </center>
         </div>
         <div>
          <center className='name'>
          <div>
          <img src={logo} alt='By Graces' id="t-l"/>
          </div>
        ...
        <div className="bp" >
          <center>
            ...
            {/* <button id='donate' type="submit" class="btn btn-outline-dark"><Link to="/donate"></Link>DONATE</button> */}
            <p id="pb"><em>Thank you for visiting our website and for your support.</em></p>
         </center>
        </div>
    </div>
 )
